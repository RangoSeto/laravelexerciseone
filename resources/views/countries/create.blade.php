    ...
    <form action="{{route('countries.store')}}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="capital" id="capital" class="form-control form-control-sm rounded-0" placeholder="Enter Capital name">
            </div>

            <div class="col-md-6 form-group mb-3">
                <label for="currency">Currency</label>
                <input type="text" name="currency" id="currency" class="form-control form-control-sm rounded-0" placeholder="Enter your Currency" />
            </div>
